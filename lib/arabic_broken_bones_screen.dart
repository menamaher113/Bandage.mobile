...
class ArabicBrokenBonesScreen extends StatefulWidget {
  const ArabicBrokenBonesScreen({Key? key}) : super(key: key);

  @override
  State<ArabicBrokenBonesScreen> createState() => _ArabicBrokenBonesScreenState();
}

class _ArabicBrokenBonesScreenState extends State<ArabicBrokenBonesScreen> {
  @override
        ...
        child: SpeedDial( //Speed dial menu
          ...
          children: [
            ...
            SpeedDialChild(
              ...
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (Context) => BrokenBonesScreen()));
              },
