...
class DizzyScreen extends StatefulWidget {
  const DizzyScreen({Key? key}) : super(key: key);

  @override
  State<DizzyScreen> createState() => _DizzyScreenState();
}

class _DizzyScreenState extends State<DizzyScreen> {
  @override
        ...
        child: SpeedDial( //Speed dial menu
          ...
          children: [
            ...
            SpeedDialChild(
              ...
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (Context) => ArabicDizzyScreen()));
              },
