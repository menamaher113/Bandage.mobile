...
class ArabicEpilepsyScreen extends StatefulWidget {
  const ArabicEpilepsyScreen({Key? key}) : super(key: key);

  @override
  State<ArabicEpilepsyScreen> createState() => _ArabicEpilepsyScreenState();
}

class _ArabicEpilepsyScreenState extends State<ArabicEpilepsyScreen> {
  @override
        ...
        child: SpeedDial( //Speed dial menu
          ...
          children: [
            ...
            SpeedDialChild(
              ...
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (Context) => EpilepsyScreen()));
              },
