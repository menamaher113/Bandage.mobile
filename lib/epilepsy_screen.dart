...
class EpilepsyScreen extends StatefulWidget {
  const EpilepsyScreen({Key? key}) : super(key: key);

  @override
  State<EpilepsyScreen> createState() => _EpilepsyScreenState();
}

class _EpilepsyScreenState extends State<EpilepsyScreen> {
  @override
        ...
        child: SpeedDial( //Speed dial menu
          ...
          children: [
            ...
            SpeedDialChild(
              ...
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (Context) => ArabicEpilepsyScreen()));
              },
