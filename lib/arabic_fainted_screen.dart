...
class ArabicFaintedScreen extends StatefulWidget {
  const ArabicFaintedScreen({Key? key}) : super(key: key);

  @override
  State<ArabicFaintedScreen> createState() => _ArabicFaintedScreenState();
}

class _ArabicFaintedScreenState extends State<ArabicFaintedScreen> {
  @override
        ...
        child: SpeedDial( //Speed dial menu
          ...
          children: [
            ...
            SpeedDialChild(
              ...
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (Context) => FaintedScreen()));
              },
